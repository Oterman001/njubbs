...
public class SPutils {
	...
	public static String getTail(){
		...
		//[1;32m·¢ËÍ×Ô ÎÒµÄĞ¡°ÙºÏAndroid¿Í»§¶Ë by PE-TL20©Y[m
		if(!TextUtils.isEmpty(tail)){
			return "\n-\n"+"[1;35mSent From "+tail+"[m\n";
		}else{
			String model = android.os.Build.MODEL;
			return "\n-\n[1;35mSent From ÄÏ´óĞ¡°ÙºÏ by "+model+"[m\n";
		}
//		if(!TextUtils.isEmpty(tail)){
//			return "\n-\n"+"<font color='purple'>Sent From  "+tail+"</font>\n";
//		}else{
//			return "\n-\n<font color='purple'>Sent From ÄÏ´óĞ¡°ÙºÏ</font>\n";
//		}
	}
	...
	public static String getTailNoColor(){
		...
		if(!TextUtils.isEmpty(tail)){
			...
			String model = android.os.Build.MODEL;
			LogUtil.d(model);
			return "Sent From ÄÏ´óĞ¡°ÙºÏ  by "+model;
		}
	}
