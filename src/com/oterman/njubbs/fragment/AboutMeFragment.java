...
public class AboutMeFragment extends Fragment implements OnClickListener {
	...
	public View onCreateView(LayoutInflater inflater,
		...
		llMail.setOnClickListener(this);//站内
		llFriends.setOnClickListener(this);// 好友
		llSetting.setOnClickListener(this);// 设置
		llMyTopic.setOnClickListener(this);// 我的帖子
	...
	private void initUserViews() {
		...
		tvTotalVisit = (TextView) rootView
				.findViewById(R.id.tv_user_totalvisit);
	...
	*/
	private void updateUserDetail2() {
		...
		ssb.setSpan(new AbsoluteSizeSpan(UiUtils.dip2px(26)), start, end,
				Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
		// ssb.setSpan(new ForegroundColorSpan(0xff8a2be2), start, end,
		// Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
		...
		tvNickName.setText(Html.fromHtml(getResources().getString(
				R.string.nickname2)
				+ userInfo.nickname));
		tvXingzuo.setText(Html.fromHtml(getResources().getString(
				R.string.xingzuo2)
				+ userInfo.xingzuo));
		tvJingyan.setText(Html.fromHtml(getResources().getString(
				R.string.jingyan2)
				+ userInfo.jingyan));
		tvLife.setText(Html.fromHtml(getResources().getString(R.string.life2)
				+ userInfo.life));
		tvBiaoxian.setText(Html.fromHtml(getResources().getString(
				R.string.biaoxian2)
				+ userInfo.biaoxian));
	...
	private void updateUserDetail() {
		tvId.setText(Html.fromHtml(getResources().getString(R.string.id2) + ""
				+ userInfo.id + ""));
		tvNickName.setText(Html.fromHtml(getResources().getString(
				R.string.nickname2)
				+ userInfo.nickname));
	...
	public void onClick(View v) {
		...
		case R.id.ll_friends:// 点击
			Intent friendsIntent = new Intent(getContext(),
					FriendsActivity.class);
			startActivity(friendsIntent);
			break;
		case R.id.ll_setting:// 设置
			// MyToast.toast("不想设置");
			Intent settingIntent = new Intent(getContext(),
