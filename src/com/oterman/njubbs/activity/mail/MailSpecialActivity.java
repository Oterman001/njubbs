 ...
 *
 */
public class MailSpecialActivity extends MyActionBarActivity implements
		OnClickListener {
		...
		ThreadManager.getInstance().createLongPool().execute(new Runnable() {
			...
			public void run() {
				...
				try {
					...
					if(cookie==null){//自动登陆
						cookie=BaseApplication.autoLogin(MailSpecialActivity.this,true);
					}
...
//								startActivity(intent);
	...
	View.OnClickListener faceClick = new View.OnClickListener() {
		...
		public void onClick(View v) {
			if (null == mFaceHelper) {
				mFaceHelper = new SelectFaceHelper(MailSpecialActivity.this, addFaceToolView);
				//点击表情时，设置监听
			...
			if (isVisbilityFace) {
				...
				hideInputManager(MailSpecialActivity.this);//隐藏软键盘
			}
		}
	};
